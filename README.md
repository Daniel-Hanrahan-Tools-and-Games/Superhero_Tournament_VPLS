# Superhero_Tournament_VPLS
 A visual programming language system version of Superhero_Tournament made in the Turbowarp fork of scratch but is compatible with vanilla Scratch. 
...
Controls: Click the buttons on screen.
